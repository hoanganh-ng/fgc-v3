...
workers, scheduler, Docker, or Web UI. Sprint 065A, Sprint 065B,
and Sprint 065C remain future work and are not activated by this
acceptance.
...
064B — Provenance Persistence And Compatibility is accepted: it
persists the Sprint 064A
`ContentCollectionProvenance` value object as a required
