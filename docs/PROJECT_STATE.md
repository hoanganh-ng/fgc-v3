...
- Sprint 047A is active. The existing account exercise worker is being made available as a separate opt-in Docker Compose service beside the collection worker.
