...
- Future account-readiness roadmap items include Ambient Exercise, Profile-Source Access State, Assisted Group Access, Category Browse Exercise, and Scheduler behavior, but those are out of scope for Sprint 038.
