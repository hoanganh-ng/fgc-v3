...
- Future account-readiness roadmap items include source group existence validation through explicit ports/API adapters, Assisted Group Access, Category Browse Exercise, Scheduler behavior, and automatic account-stage recommendations, but those are out of scope for Sprint 041A.
