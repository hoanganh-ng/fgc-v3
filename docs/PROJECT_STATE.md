...
- Future account-readiness roadmap items include Assisted Group Access, Category Browse Exercise, Scheduler behavior, and automatic account-stage recommendations, but those are out of scope for Sprint 042.
