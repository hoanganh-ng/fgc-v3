...
} from "../../schemas/collector-runtime/collection-runs.http-schemas";
...
export function registerCollectionRunsRoutes(
...
export { registerCollectionRunsRoutes as registerCollectionRunRoutes };
